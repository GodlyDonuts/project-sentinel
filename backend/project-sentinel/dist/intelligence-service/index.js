...
// src/intelligence-service/index.ts
import { Service } from "./runtime.js";

// src/intelligence-service/utils.ts
var createPrompt = (content) => {
  return `Is the following text a scam? Respond with only JSON. ${content}`;
};
async function analyzeContent(env, request) {
  try {
...
// src/intelligence-service/index.ts
var intelligence_service_default = class extends Service {
  async fetch() {
...
// <stdin>
var stdin_default = intelligence_service_default;
export {
  cors,
