...
// src/storage-service/utils.ts
var insertScamRecord = async (db, record) => {
...
async function createScamRecord(env, request) {
  const newRecord = {
    id: v4_default(),
    ...request,
...
async function getScamRecord(env, id) {
  try {
...
// src/storage-service/index.ts
var storage_service_default = class extends Service {
  async fetch() {
...
// <stdin>
var stdin_default = storage_service_default;
export {
  cors,
